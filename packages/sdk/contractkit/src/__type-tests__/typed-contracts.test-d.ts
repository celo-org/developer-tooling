 ...
 * that proxySend and .read enforce correct method names and argument types
...
import { proxySend } from '../wrappers/BaseWrapper'
...
// The ContractLike<TAbi> parameter type ensures it works with proxySend and .read.
declare const celoContract: CeloContract<typeof accountsABI>

// Test 9: proxySend with CeloContract and correct method name compiles
void proxySend(connection, celoContract, 'createAccount')

// Test 10: proxySend with CeloContract rejects incorrect method name
// @ts-expect-error - 'createAcount' is not a valid method name on Accounts contract
