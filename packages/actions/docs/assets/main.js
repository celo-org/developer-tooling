  ...
  var et = (t, e, n, r) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let i of Ge(e))
        !Ye.call(t, i) &&
          i !== n &&
          he(t, i, { get: () => e[i], enumerable: !(r = Ke(e, i)) || r.enumerable })
    return t
  }
  var tt = (t, e, n) => (
    (n = t != null ? Je(Xe(t)) : {}),
    et(e || !t || !t.__esModule ? he(n, 'default', { value: t, enumerable: !0 }) : n, t)
  )
  var ye = Ze((me, ge) => {
    ;(function () {
      var t = function (e) {
  ...
  function xe(t, e) {
    t.addEventListener('animationend', () => {
      t.classList.contains(Z) &&
        (t.classList.remove(Z), document.getElementById(ae)?.remove(), t.close(), it())
    }),
    ...
    for (let a = 0; a < o; a++) {
      let c = r.data.rows[Number(s[a].ref)],
        d = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon" aria-label="${window.translations[
          `kind_${c.kind}`
        ].replaceAll('"', '&quot;')}"><use href="#icon-${c.icon || c.kind}"></use></svg>`,
        f = Ce(c.name, i)
