...
▸ **getFeeCurrencyInformation**(`whitelist?`): `Promise`\<\{ `address`: \`0x$\{string}\` ; `name`: `undefined` \| `string` ; `symbol`: `undefined` \| `string`  }[]\>
...
`Promise`\<\{ `address`: \`0x$\{string}\` ; `name`: `undefined` \| `string` ; `symbol`: `undefined` \| `string`  }[]\>
