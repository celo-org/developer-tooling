...
optional callback returning the current default
...
optional async callback returning the chain ID of the
...
optional callback returning the connection-level
