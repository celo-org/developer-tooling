...
[@celo/connect](../globals.md) / readOnlyWalletToAccount

# Function: readOnlyWalletToAccount()

> **readOnlyWalletToAccount**(`wallet`, `address`): `object`

Defined in: [packages/sdk/connect/src/wallet-adapter.ts:19](https://github.com/celo-org/developer-tooling/blob/master/packages/sdk/connect/src/wallet-adapter.ts#L19)
...
A viem LocalAccount backed by the wallet
...
> `optional` **sign**: (`parameters`) => `Promise`\<`` `0x${string}` ``\>
